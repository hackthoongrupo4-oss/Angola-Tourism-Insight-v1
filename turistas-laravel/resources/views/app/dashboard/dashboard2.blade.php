         ...
         <div class="col-lg-3 col-sm-6 col-12">
            <div class="card shadow-sm d-flex flex-row">
                ...
                <div class="card-body text-center flex-grow-1">
                    ...
                    <p class="card-text">Plano ativo</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card shadow-sm d-flex flex-row">
                ...
                <div class="card-body text-center flex-grow-1">
                    ...
                    <h4 class="card-title"> </h4>
                    <p class="card-text">Data Inicio do plano</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card shadow-sm d-flex flex-row">
                ...
                <div class="card-body text-center flex-grow-1">
                    <i class="bi bi-file-earmark fs-1 mb-2"></i>
                    <h4 class="card-title"> </h4>
                    <p class="card-text"> Data limite do plano</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="card shadow-sm d-flex flex-row">
                ...
                <div class="card-body text-center flex-grow-1">
                    ...
                    <h4 class="card-title"></h4>
                    <p class="card-text">Serviços com destaques</p>
                </div>
            </div>
        </div>
