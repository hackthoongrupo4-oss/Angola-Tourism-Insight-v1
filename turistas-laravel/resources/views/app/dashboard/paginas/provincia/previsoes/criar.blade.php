  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('previsoes.store') }}" method="POST" id="formPrevisao" onsubmit="let btn=this.querySelector('button[type=submit]');btn.disabled=true;btn.innerText='A processar...';">
          @csrf
