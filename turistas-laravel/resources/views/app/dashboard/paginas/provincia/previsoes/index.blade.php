                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                         ...
                                         <a class="btn btn-sm btn-outline-primary" href="{{route('previsoes.show',$historico->id)}}"  title="Ver detalhes">
                                ...
                                <div class="modal fade" id="deleteModal{{ $historico->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $historico->id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p>Tem a certeza que deseja eliminar o histórico registado em <strong>{{ $historico->created_at->format('d/m/Y H:i') }}</strong> (Sugestão: <strong>{{ $historico->nome_sugestao }}</strong>)?</p>
                                            </div>
                                            <div class="modal-footer">
