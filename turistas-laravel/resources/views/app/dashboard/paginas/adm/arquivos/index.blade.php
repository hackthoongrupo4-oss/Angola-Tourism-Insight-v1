...
<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Arquivos gerais /</span> Todos Arquivos</h4>
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('arquivos2.show', $a->id) }}" class="btn btn-sm btn-outline-info"><i class="bx bx-show"></i></a>

        <!-- Editar Status -->
        <button class="btn btn-sm btn-outline-warning" data-bs-toggle="modal" data-bs-target="#editStatusModal-{{ $a->id }}">
