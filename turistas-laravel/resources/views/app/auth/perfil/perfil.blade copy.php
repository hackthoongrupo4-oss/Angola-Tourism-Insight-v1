                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <div class="button-wrapper">
                          ...
                          <p class="text-muted mb-0">Formatos JPG, GIF or PNG. Tamanho máximo  800K</p>
                        </div>
                      </div>
                    </div>
                    <hr class="my-0" />
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" onsubmit="return false">
                       ...
                       <div class="mb-3 col-md-6">
                            <label class="form-label" for="country">Província</label>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="language" class="form-label">Municipio</label>
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="address" class="form-label">Biografia</label>
