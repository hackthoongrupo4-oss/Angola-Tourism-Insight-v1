...
Route::get('/dashboard1',[UsuarioController::class,'index'] )->middleware(['auth', 'verified'])->name('dashboard1');
    ...
    Route::resource('provincias', ProvinciaController::class)->middleware('roles:admin')->except(['show', 'create', 'edit']);
    
    // Resource padrão para sugestões
    Route::resource('sugestaos', SugestaoController::class);


    Route::get('provincias/{provincia}/usuarios', [UsuarioController::class, 'usuarios'])->middleware('roles:admin')
